export default function Modal({ isOpen, modal_id, setClose}) {
  if (!isOpen) return null
  return (

    <div className="fixed inset-0 bg-gray-600/75 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-[60%] h-[50%] mx-auto shadow-xl relative">
        <button
          onClick={() => setClose()}
          className="absolute top-4 right-4 text-gray-400 hover:text-gray-800 transition-colors outline-none"
